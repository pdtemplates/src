...
.value('taTranslations', {
    ...
    insertTID: {
        tooltip: 'Insert / edit TID (mlink value)',
        dialogPrompt: "Insert TID (mlink value)"
    },
    editLink: {
        reLinkButton: {
            tooltip: "relink"
...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', function (taRegisterTool, $window, taTranslations, taSelection) {
    ...
    taRegisterTool('insertLink', {
        ...
        action: function () {
            ...
            urlTID = $window.prompt(taTranslations.insertTID.dialogPrompt, 'Insert TID (mlink value)');
            ...
            if (urlLink && urlLink !== '' && urlLink !== 'http://') {
                return this.$editor().wrapSelection('insertHTML', '<a href='+urlLink+' onclick=\"return wcdLib.contentItemLinkWithFacet(this,\'\',\''+urlTID+'\');\">'+linkText+'</a>', true);
            }
        },
        activeState: function (commonElement) {
